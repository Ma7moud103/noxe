...
export default function TrendingMovies() {
    const { getMovies, searchInput } = useContext(MainContext)
        ...
        <>
            {Movies.length ?
                <div className="container mx-auto px-10">
                    <div className='grid md:grid-cols-4 sm:grid-cols-2 grid-cols-5 gap-y-10 gap-x-3 my-10'>
                        <div className='col-span-2 flex flex-col'>
                            ...
                            <h2 className='text-4xl pb-4'>Trending <br /> Movies To <br /> Watch Right Now</h2>
                            <p>Most Watched Movies By Days</p>
                            <div id='line' className="bg-slate-600 w-3/4 mt-3"></div>
                        </div>
                        {
                            Movies.slice(0, 10).map(Movie => (<Fragment key={Movie.id}>
